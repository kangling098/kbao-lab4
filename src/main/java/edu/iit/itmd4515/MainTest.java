...
/**
 * Alternative Main class for NetBeans to run the JPA project using test persistence unit.
 * This avoids JNDI issues by using the RESOURCE_LOCAL persistence unit.
 */
public class MainTest {
    ...
    public static void main(String[] args) {
        LOG.info("Starting JPA Lab 5 - Relationships Demo (Test Configuration)");
        
        // Create EntityManagerFactory using test persistence unit
